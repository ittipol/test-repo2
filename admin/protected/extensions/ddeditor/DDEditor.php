...
/*         $cs->registerScript($scriptId.$c++,"jQuery('#".$this->editorId."-editor-h').change(function(){insertTags('".$this->editorId."',padText('#',this.value)+' ',' '+padText('#',this.value),'Heading '+this.value)});"); */
        ...
        $cs->registerScript($scriptId.$c++,"jQuery('#".$this->editorId."-editor-h1').click(function(){insertTags('".$this->editorId."','# ',' #','Heading 1')});");
        $cs->registerScript($scriptId.$c++,"jQuery('#".$this->editorId."-editor-h2').click(function(){insertTags('".$this->editorId."','## ',' ##','Heading 2')});");
        $cs->registerScript($scriptId.$c++,"jQuery('#".$this->editorId."-editor-h3').click(function(){insertTags('".$this->editorId."','### ',' ###','Heading 3')});");
/*
        $cs->registerScript($scriptId.$c++,"jQuery('#".$this->editorId."-editor-h4').click(function(){insertTags('".$this->editorId."','#### ',' ####','Heading 4')});");
        $cs->registerScript($scriptId.$c++,"jQuery('#".$this->editorId."-editor-h5').click(function(){insertTags('".$this->editorId."','##### ',' #####','Heading 5')});");
*/
